...
const routes: Routes = [
  ...
  { path: "EmergencyPrescribe/entry/:id", component: EmergencyPrescriptionComponent },
  ...
  { path: "AppointmentPrescribe/entry/:id", component: AppointmentPrescriptionComponent },
